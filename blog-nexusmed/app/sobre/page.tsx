    ...
    <>
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            <div className="flex-1">
              ...
              <p className="text-base leading-relaxed mb-4" style={{ color: 'var(--nexus-gray-600)', fontFamily: 'Inter, sans-serif' }}>
                O Blog NexusMed nasceu de uma constatação: <strong>a maioria dos médicos e gestores de clínicas não tem acesso fácil a conteúdo de qualidade sobre gestão</strong>. Falta tempo, faltam fontes confiáveis, e sobram informações genéricas que não se aplicam à realidade de uma clínica médica brasileira.
              </p>
              <p className="text-base leading-relaxed" style={{ color: 'var(--nexus-gray-600)', fontFamily: 'Inter, sans-serif' }}>
                Publicamos artigos práticos e aprofundados, escritos por especialistas, para ajudar clínicas a se tornarem mais <strong>eficientes, lucrativas e focadas no paciente</strong>.
              </p>
            </div>
            ...
            >
              <div className="w-12 h-12 rounded-2xl flex items-center justify-center text-2xl mb-4" style={{ background: '#E0F5EE' }}>
                🏥
              </div>
              <h3 className="font-bold text-base mb-2" style={{ color: 'var(--nexus-navy)', fontFamily: 'Poppins, sans-serif' }}>
                NexusMed — A Plataforma
              </h3>
              ...
              <Link
                ...
                style={{ color: '#00875A', fontFamily: 'Poppins, sans-serif' }}
              >
                Conhecer o sistema →
              </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {TOPICS.map((t) => (
              <div
                key={t.title}
                className="nexus-card p-5 flex gap-4 items-start"
              >
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold mb-3" style={{ color: 'var(--nexus-navy)', fontFamily: 'Poppins, sans-serif' }}>
            Comece a ler agora
          </h2>
