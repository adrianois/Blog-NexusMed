          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="relative w-9 h-9 flex-shrink-0">
              <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-9 h-9">
                {/* Cruz azul */}
                <path d="M10 13h16v10H10z" fill="#1E88E5" rx="2"/>
                <path d="M13 10h10v16H13z" fill="#1E88E5" rx="2"/>
                {/* Sobreposição verde */}
            ...
            <div className="leading-none">
              ...
              <span className="text-xs block mt-0.5" style={{ color: 'rgba(255,255,255,0.5)', fontFamily: 'Inter, sans-serif', letterSpacing: '0.02em' }}>Blog</span>
            </div>
          </Link>

          {/* Nav Desktop */}
          <nav className="hidden md:flex items-center gap-6">
            <Link href="/blog" className="text-sm font-medium transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.75)', fontFamily: 'Inter, sans-serif' }}>
              Artigos
            </Link>
            ...
            <Link href="/sobre" className="text-sm font-medium transition-colors hover:text-white" style={{ color: 'rgba(255,255,255,0.75)', fontFamily: 'Inter, sans-serif' }}>
              Sobre
            </Link>
